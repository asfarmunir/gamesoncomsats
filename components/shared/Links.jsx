...
const Navlinks = ({ sessionData }) => {
    ...
    const adminLinks = [
        ...
        {
            text: sessionData.data.user.role === 'admin' ? 'inventory' : 'equipments',
            description: sessionData.data.user.role === 'admin' ? "Manage equipments" : 'Book Item',
            icon: <GiDatabase />,
            href: "/inventory"
        },
        {
            text: "Events",
            description: sessionData.data.user.role === 'admin' ? "Manage events" : 'Check events',
            icon: <MdEmojiEvents />,
            href: "/events"
        },
        {
        ...
        {
            text: sessionData.data.user.role === 'admin' ? 'LiveScore' : "Fixtures",
